...
<head>
    ...
    <script type="text/javascript">
        ...
        function openGradeDeleteDialog() {
            ...
            $.messager.confirm("系统提示", "您确认要删掉这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("${pageContext.request.contextPath}/grade?method=del",
        ...
        function openGradeAddDialog() {
            ...
            url = "${pageContext.request.contextPath}/grade?method=save";
        }
        ...
        function openGradeModifyDialog() {
            ...
            $("#fm").form("load", row);
            url =
                "${pageContext.request.contextPath}/grade?method=update&gradeId="
                + row.gradeId;
        }
...
<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
       ...
       url="${pageContext.request.contextPath}/grade?method=gradeList"
       fit="true"
...
<div id="tb">
    <div>
        ...
        <a href="javascript:openGradeDeleteDialog()" class="easyui-linkbutton"
           iconCls="icon-remove" plain="true">删除</a>
    </div>
    <div>&nbsp;班级名称：&nbsp;<input type="text" name="s_gradeName"
                                 id="s_gradeName"/><a
...
<div id="dlg-buttons">
    ...
    <a href="javascript:closeGradeDialog()" class="easyui-linkbutton"
